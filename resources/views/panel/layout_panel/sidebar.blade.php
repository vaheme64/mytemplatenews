 ...
 <nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-overlay-slide from-top" id="appMenu">
      <div class="row">
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-40"><img src="{{asset('panel')}}/img/demo/social_app.svg" alt="socail">
          </a>
        </div>
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-10"><img src="{{asset('panel')}}/img/demo/email_app.svg" alt="socail">
          </a>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-40"><img src="{{asset('panel')}}/img/demo/calendar_app.svg" alt="socail">
          </a>
        </div>
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-10"><img src="{{asset('panel')}}/img/demo/add_more.svg" alt="socail">
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="sidebar-header">
      <img src="{{asset('panel')}}/img/logo_white.png" alt="logo" class="brand" data-src="{{asset('panel')}}/img/logo_white.png" data-src-retina="{{asset('panel')}}/img/logo_white_2x.png" width="78" height="22">
