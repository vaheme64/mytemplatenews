                    ...
                    <div class="notification-item unread clearfix">
                      <div class="heading">
                        <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                          <img width="30" height="30" data-src-retina="{{asset('panel')}}/img/profiles/1x.jpg" data-src="{{asset('panel')}}/img/profiles/1.jpg" alt="" src="{{asset('panel')}}/img/profiles/1.jpg">
                        </div>
                        <a href="#" class="text-complete pull-left">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown pull-right hidden-md-down">
          <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <img src="{{asset('panel')}}/img/profiles/avatar.jpg" alt="" data-src="{{asset('panel')}}/img/profiles/avatar.jpg" data-src-retina="{{asset('panel')}}/img/profiles/avatar_small2x.jpg" width="32" height="32">
            </span>
          </button>
