...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" href="{{asset('panel')}}/pages/ico/60.png">
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('panel')}}/pages/ico/76.png">
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset('panel')}}/pages/ico/120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('panel')}}/pages/ico/152.png">
  ...
  <body class="fixed-header menu-pin menu-behind">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="{{asset('panel')}}/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src="{{asset('panel')}}/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src-retina="{{asset('panel')}}/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" alt="" class="lazy">
        <!-- END Background Pic-->
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="{{asset('panel')}}/img/demo/pages_icon.png" data-src-retina="{{asset('panel')}}/img/demo/pages_icon_2x.png" height="60" src="{{asset('panel')}}/img/demo/pages_icon.png" width="60">
              </div>
